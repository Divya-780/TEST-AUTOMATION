describe('DELETE impromptu question API Test', function () {
    it('Verifies that API deletes the impromptu questions', function () {

        cy.request({
            url: 'https://dev02.speechpundit.com/api/lessons/impromptu_questions_delete/527/',
            method: "DELETE",
            headers: {
