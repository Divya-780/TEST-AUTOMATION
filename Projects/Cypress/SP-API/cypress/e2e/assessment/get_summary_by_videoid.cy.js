describe('GET assessment summary of the video', function () {
    it('Verifies that API returns assessment summary report of video', function () {

        cy.request({
            url: 'https://dev02.speechpundit.com/api/assessment/summary/2828/',
            method: "GET",
            headers: {
            ...
            (response) => {
                ...
                expect(response.body).to.have.property('TemplateInfo')
