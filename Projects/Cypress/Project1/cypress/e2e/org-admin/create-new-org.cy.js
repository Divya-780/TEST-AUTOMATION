...
describe("As a super admin, I shall be able to create a new org.", function () {
  it(" sign in with valid credentials", function () {
    ...
    cy.get("#orgDescription").type(
      "he students choose what and how to learn and are supported in their learning by the teacher. But the ultimate decisions about learning are made by the students."
    );
    ...
    //-- VALIDATION --//
    cy.contains(
      "New Organization added successfully. Login details sent to"
    ).should("exist");
    //--TEAR DOWN --//
