//Coach shall be able to Archive the group.
describe("Coach shall be able to Archive the group.", function () {
  it("Coach shall be able to Archive the group.", function () {
    ...
    cy.get("#name").type("Archive Group");
    ...
    cy.wait(1000);
    cy.get(".fa-file-archive").click();
    cy.get(".p-dialog-footer > .btn-secondary").click();

    //validation for Archived Group
    cy.wait(4000);
    cy.get("#dropdownOne").click();
